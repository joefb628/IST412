...
public class MainMenuView extends JFrame{
    ...
    private void initComponents(String username) {
        ...
        JButton alterRecordsButton = new JButton("<html><font size='4'>Alter Medical Records</font></html>");
        alterRecordsButton.addActionListener(event -> mainMenuCntl.openAlterRecord());
